  ...
  <div class="p-2 flex flex-col h-full items-center">
    <div class="flex flex-col items-center p-2 mb-4">
      ...
      <div class="flex gap-2">
        <a class="border-b" href="https://github.com/czarandy/awakened-poe-trade/releases" target="_blank">{{ t('app.release_notes') }}</a>
        <a class="border-b" href="https://github.com/czarandy/awakened-poe-trade/issues" target="_blank">{{ t('app.report_bug') }}</a>
      </div>
    </div>
